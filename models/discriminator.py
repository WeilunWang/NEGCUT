...
import functools
from models.stylegan_networks import StyleGAN2Discriminator
from models.utils import init_net, get_norm_layer
...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d, no_antialias=False):
        ...
        # If train on Horse2Zebra and Cityscapes, Apply this part of code.
        ...
        # If train on AFHQ, Apply this part of code
        # On AFHQ dataset, we do not use PatchGAN.
        # When this code is applied, set 'netD' as 'n_layers' and 'n_layers_D' as 6.
